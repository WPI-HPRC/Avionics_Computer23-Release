...
bool ICM42688P::setup(){
    ...
    Serial.println("Who am I check passed");
    if(!sensorEnable()){
        Serial.println("Sensor enable failed");
        return false;
    }
    Serial.println("Sensor enable passed");
    if(!setODR_FS()){
        Serial.println("Set ODR and FS failed");
        return false;
    }
    Serial.println("Set ODR and FS passed");
    if(!setFilters()){
        Serial.println("Set filters failed");
        return false;
    }
    Serial.println("Set filters passed");
